...
| is there any data that should not be protected? how does a user categorize? does app show diff categories
...
| isnt' this more a user security issue?
...
| what happens if os enc is not turned on?
