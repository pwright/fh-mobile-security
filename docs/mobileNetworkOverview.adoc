...
| SMS - are you saying to use it somehwere else?
...
==== Certificate Pinning
The main code logic for certificate pinning is found under https://github.com/feedhenry/mobile-security-android-template/blob/master/app/src/main/java/com/feedhenry/securenativeandroidtemplate/domain/services/AuthStateService.java[here] in the AuthStateService class.
...
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-android-template/master/app/src/main/res/xml/network_security_config.xml[]
....
...
[source,java,linenums,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-android-template/master/app/src/main/java/com/feedhenry/securenativeandroidtemplate/domain/services/AuthStateService.java[tags=checkCertificateVerificationError]
....
...
[source,java,linenums,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-android-template/master/app/src/main/java/com/feedhenry/securenativeandroidtemplate/features/network/presenters/UploadNotesPresenter.java[tags=checkPermission]
....
...
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security/master/projects/api-server/index.js[tags=checkPermission]
....
...
[source,java,linenums,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-android-template/master/app/src/main/java/com/feedhenry/securenativeandroidtemplate/features/network/presenters/UploadNotesPresenter.java[tags=invokeAPI]
....

=== iOS

==== Certificate Pinning
The https://github.com/feedhenry/mobile-security-ios-template/blob/master/secure-ios-app/services/CertPinningService.swift[Certificate Pinning Service] and the https://github.com/feedhenry/mobile-security-ios-template/blob/master/secure-ios-app/AppDelegate.swift[AppDelegate] contain the main code for configuring and performing certificate pinning.
...
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/AppDelegate.swift[tags=trustkitConfig]
....

The `performValidCertCheck()` function in the https://github.com/feedhenry/mobile-security-ios-template/blob/master/secure-ios-app/services/CertPinningService.swift[Certificate Pinning Service] can be used to manually check if a request to a host fails due to certificate pinning validation issues.

.Code
[source,swift,linenums,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/services/CertPinningService.swift[tags=performValidCertCheck]
....
...
[source,swift,linenums,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/authentication/AuthenticationViewController.swift[tags=onAuthButtonTapped]
....
